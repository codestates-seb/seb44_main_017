...
public class AdminJwtVerificationFilter extends OncePerRequestFilter {
    private final JwtTokenizer jwtTokenizer;
    private final AdminCustomAuthorityUtils authorityUtils;
    private final RefreshTokenRepository refreshTokenRepository;

    public AdminJwtVerificationFilter(JwtTokenizer jwtTokenizer, AdminCustomAuthorityUtils authorityUtils, RefreshTokenRepository refreshTokenRepository){
    ...
    private void setAuthenticationToContext(Map<String, Object> claims) {
        ...
        Authentication authentication = new UsernamePasswordAuthenticationToken(adminname, null, authorities);
